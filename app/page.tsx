...
export default function Home() {
  return (
    <div className='min-h-screen p-3 sm::p-8 pb-4 font-[family-name:var(--font-geist-mono)]'>
      {/* Header Section */}
      ...
      <div className='grid grid-cols-[6px_1fr_6px] sm:grid-cols-[20px_1fr_20px] justify-items-center mt-8 sm:mt-16'>
        <div className='w-full sm:max-w-2xl col-start-2'>
          ...
          <div className='sm:px-6 pb-3'>
            <Link
              href={"/"}
              className='grid grid-cols-1 sm:grid-cols-[100px_1fr_16px] items-start gap-2 sm:gap-12 sm:p-3 sm:hover:bg-amber-100 sm:hover:rounded-2xl sm:dark:hover:bg-[#C59849]'
            >
              ...
              <div className='flex flex-col'>
                <h3 className='font-semibold'>
                  <span className='underline sm:no-underline underline-offset-2'>
                    Iscicle
                  </span>{" "}
        ...
        <div className='w-full sm:max-w-2xl col-start-2 '>
          ...
          <div className='pb-8 sm:px-6 sm:pb-3'>
            ...
            >
              ...
              <div>
                <h3 className='font-semibold underline sm:no-underline underline-offset-2'>
                  Transfer Tea
                </h3>
                <p className='text-sm font-extralight'>
